    ...
    <div style={{zIndex:"2"}}>
      <footer style={{display:"flex", flexDirection:"column", marginTop:"", justifyContent:"center", alignItems:"center", backgroundColor:"black"}}>
        ...
        <div className="logo-footer" style={{width:"50%", backgroundColor:"black"}}>
          ...
          <div style={{display:"flex", justifyContent:"center", gap:"9~vw", marginTop:"5%", backgroundColor:"black"}}>
          ...
          <div style={{display:"flex", flexDirection:"column", backgroundColor:"transparent"}}>
            <div className="newsletter" style={{display:"flex", flexDirection:"column", justifyContent:"center", backgroundColor:"transparent"}}>
              ...
              <form className="news-latter" style={{ width:"80%", backgroundColor:"transparent"}}>
                ...
                <button className="about-login" style={{marginLeft:"-25%", width:"24%"}}><a id="btn-text" href="mailto:chandan1012004@gmail.com"> Subscribe</a></button>
              </form>
            </div>
