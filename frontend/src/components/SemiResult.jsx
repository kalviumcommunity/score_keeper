...
function SemiResult() {
    return (
        <div className='newgame-page'>
            <TextField className='gametitle-sm' id="outlined-basic" label="This is the Game Title !!" variant="outlined" />
            ...
            <div className='main-part-down-sm'>
                ...
                <h1 className='win-text'>"Player 1" wins the game with a score of “ 21 / 0 “</h1>
            </div>    
        </div>
      )
    }
